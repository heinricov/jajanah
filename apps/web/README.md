...
Aplikasi web publik **jajanah** — [Next.js](https://nextjs.org) 16 (App Router, Turbopack) + komponen dari [`@packages/ui`](../../packages/ui/README.md). Berjalan di port **3000**.

## Perintah

| Perintah                      | Deskripsi                                   |
| ----------------------------- | ------------------------------------------- |
| `pnpm --filter web dev`       | Dev server di `http://localhost:3000`       |
| `pnpm --filter web build`     | Production build                            |
| `pnpm --filter web start`     | Jalankan production server (port 3000)      |
